-- ============================================================
-- WARNING: STALE REFERENCE SNAPSHOT — DO NOT EXECUTE DIRECTLY
--
-- This file reflects the initial schema only. It does NOT include
-- migrations ≥013 (status_override, company_updates, valuations
-- unique constraint, and any subsequent changes).
--
-- AUTHORITATIVE source: src/db/migrations/
-- To set up or migrate the schema, run:
--   node src/cli.js db:setup      (fresh install)
--   node src/cli.js db:migrate    (apply pending migrations)
-- ============================================================
